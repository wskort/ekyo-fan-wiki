...
## Setup from [[Bandit18 - Compare files]]
```bash
...
## Method
```bash
# You can add a command to execute once the ssh connection
# is running, which will be performed _before_ you're 
# booted from the system again. 

$ ssh bandit18@bandit.labs.overthewire.org -p 2220 'cat readme'
This is a OverTheWire game server. More information on http://www.overthewire.org/wargames

Enter passphrase for key '/home/prl/.ssh/id_rsa': 
bandit18@bandit.labs.overthewire.org's password: 
# Paste and submit the previous password

# And then we get this!
IueksS7Ubh8G3DCwVzrTd8rAVOwq3M5x
# And are promptly removed again.
```
